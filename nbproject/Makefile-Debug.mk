...
${OBJECTDIR}/BusquedaLocal.o: BusquedaLocal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BusquedaLocal.o BusquedaLocal.cpp

${OBJECTDIR}/BusquedaTabu.o: BusquedaTabu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BusquedaTabu.o BusquedaTabu.cpp
